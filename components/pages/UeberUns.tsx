...
const content = {
  de: {
    ...
    subtitle: "Wir verbinden Kreditnehmer und Anleger auf unserer innovativen Plattform und demokratisieren den Zugang zu fairen Finanzierungen.",
    stats: [
    ...
    links: [
      { title: "Was ist Crowdlending?", href: "/ueber-uns/crowdlending", icon: "info" },
  ...
  en: {
    ...
    subtitle: "We connect borrowers and investors on our innovative platform, democratizing access to fair financing.",
    stats: [
    ...
    mission: {
      ...
      text: "We believe everyone deserves access to fair loans. Our platform enables individuals and SMEs to obtain favorable loans while investors achieve attractive returns. Through innovative technology and transparent processes, we create trust between all parties.",
    },
    history: {
      title: "Our History",
      subtitle: "From Switzerland's first crowdlending platform to a leading FinTech company.",
      items: [
        ...
        { year: "2024", event: "Over CHF 2.5 billion total funded volume achieved" },
      ],
    },
    values: {
      title: "Our Values",
    ...
    links: [
      { title: "What is Crowdlending?", href: "/en/about/crowdlending", icon: "info" },
  ...
  fr: {
    ...
    subtitle: "Nous connectons emprunteurs et investisseurs sur notre plateforme innovante, democratisant l'acces a un financement equitable.",
    stats: [
    ...
    history: {
      ...
      subtitle: "De la premiere plateforme de crowdlending suisse a une entreprise FinTech leader.",
      items: [
        ...
        { year: "2024", event: "Plus de CHF 2,5 milliards de volume total finance atteint" },
      ],
    },
    values: {
      title: "Nos Valeurs",
    ...
    links: [
      { title: "Qu'est-ce que le crowdlending?", href: "/fr/a-propos/crowdlending", icon: "info" },
      { title: "Statistiques", href: "/fr/a-propos/statistiques", icon: "chart" },
        ...
        <div class="about-mission__container">
          ...
          <div class="about-mission__visual">
            <div class="about-mission__graphic">
              <svg class="about-mission__graphic-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
