...
const navigation = {
  de: {
    ...
    investItems: [
      ...
      { label: "Institutionelle Anleger", href: "/investieren/institutionelle" },
    ],
  ...
  en: {
    ...
    investItems: [
      { label: "Private Investors", href: "/en/invest/private-investors" },
  ...
  fr: {
    ...
    investItems: [
      { label: "Investisseurs privés", href: "/fr/investir/investisseurs-prives" },
