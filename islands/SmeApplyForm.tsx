...
const content = {
  de: {
    ...
    form: {
      ...
      ctaLink: "https://app.cashare.ch/de/borrower/register?type=sme",
    },
    rates: {
  ...
  en: {
    ...
    form: {
      ...
      submit: "Apply Now",
      ctaLink: "https://app.cashare.ch/en/borrower/register?type=sme",
    },
    rates: {
  ...
  fr: {
    ...
    form: {
      ...
      ctaLink: "https://app.cashare.ch/fr/borrower/register?type=sme",
    },
    rates: {
