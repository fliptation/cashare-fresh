...
export default function LoanApplyForm({ locale }: LoanApplyFormProps) {
  ...
  const resultsMin = useComputed(() => {
    if (amount.value < 1000 || amount.value > 1000000) return null;
    if (duration.value < 1 || duration.value > 60) return null;
