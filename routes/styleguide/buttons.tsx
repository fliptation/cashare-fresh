    ...
    <div class="styleguide">
      <div class="styleguide__container">
        ...
        <section class="styleguide__section">
          ...
          <div class="styleguide__group">
            <h3 class="styleguide__group-title">Dark</h3>
            <p class="styleguide__description">Sekundäre Aktionen</p>
            <div class="styleguide__demo">
              <button class="btn btn--dark">Dark Button</button>
            </div>
            <code class="styleguide__code">.btn .btn--dark</code>
          </div>
        ...
        <section class="styleguide__section">
          ...
          <div class="styleguide__group">
            ...
            <p class="styleguide__description">
              Bewege die Maus über die Buttons
            </p>
            <div class="styleguide__demo styleguide__demo--row">
              <button class="btn btn--primary styleguide__hover-demo">
                Primary Hover
              </button>
              <button class="btn btn--dark styleguide__hover-demo">
                Dark Hover
              </button>
              <button class="btn btn--outline styleguide__hover-demo">
                Outline Hover
              </button>
              <button class="btn btn--white styleguide__hover-demo">
                White Hover
              </button>
            </div>
          </div>
          ...
          <div class="styleguide__group">
            ...
            <div class="styleguide__demo styleguide__demo--row">
              ...
              <button class="btn btn--dark">Dark Active</button>
          ...
          <div class="styleguide__group">
            ...
            <div class="styleguide__demo styleguide__demo--row">
              ...
              <button class="btn btn--white" disabled>White Disabled</button>
            </div>
            <code class="styleguide__code">
              disabled Attribut oder .btn--disabled
            </code>
          </div>
          ...
          <div class="styleguide__group">
            ...
            <div class="styleguide__demo styleguide__demo--row">
              ...
              <button class="btn btn--dark">Dark Focus</button>
        ...
        <section class="styleguide__section">
          ...
          <div class="styleguide__group">
            ...
            <div class="styleguide__demo styleguide__demo--row">
              ...
              <button class="btn btn--dark hover-lift">Hover Lift</button>
            </div>
          ...
          <div class="styleguide__group">
            ...
            <p class="styleguide__description">
              Wird beim Klicken leicht kleiner
            </p>
            <div class="styleguide__demo styleguide__demo--row">
              <button class="btn btn--primary hover-press">Hover Press</button>
              <button class="btn btn--dark hover-press">
                Hover Press
              </button>
            </div>
          ...
          <div class="styleguide__group">
            ...
            <div class="styleguide__demo styleguide__demo--row">
              <button class="btn btn--outline shadow-primary">
                Shadow Primary
              </button>
            </div>
        ...
        <section class="styleguide__section">
          ...
          <div class="styleguide__group">
            <p class="styleguide__description">
              Buttons können auch als {"<a>"} Tags verwendet werden
            </p>
            <div class="styleguide__demo styleguide__demo--row">
              <a href="#" class="btn btn--primary">Link Primary</a>
              <a href="#" class="btn btn--dark">Link Dark</a>
              <a href="#" class="btn btn--outline">Link Outline</a>
              <a href="#" class="btn btn--white">Link White</a>
            </div>
          </div>
        </section>
            ...
            <table class="styleguide__table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn--white btn--lg">Button</button>
                  </td>
                  <td>
                    <button class="btn btn--white" disabled>Button</button>
                  </td>
                </tr>
