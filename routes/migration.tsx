...
const migrationData: MigrationSection[] = [
  {
    ...
    items: [
      ...
      { name: "JSON-LD Schema", status: "done", notes: "Organization, Website, BreadcrumbList" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "So funktioniert's", newUrl: "/so-funktionierts", status: "done", notes: "Neue Seite" },
      { name: "So funktioniert's: Privatkredit", newUrl: "/so-funktionierts/privatkredit", status: "done" },
      { name: "So funktioniert's: KMU", newUrl: "/so-funktionierts/kmu", status: "done" },
      { name: "So funktioniert's: Hypothek", newUrl: "/so-funktionierts/hypothek", status: "done" },
      { name: "Privatdarlehen beantragen", newUrl: "/privatdarlehen-beantragen", status: "done", notes: "Antrag-Formular" },
      { name: "KMU Kredit beantragen", newUrl: "/kmu-kredit-beantragen", status: "done", notes: "Antrag-Formular" },
      { name: "KMU Kurzkredit beantragen", newUrl: "/kmu-kurzkredit-beantragen", status: "done", notes: "Antrag-Formular" },
    ],
  },
  {
    title: "Über uns",
    items: [
      ...
      { name: "Rating", oldUrl: "/ueber-uns/rating/", newUrl: "/ueber-uns/rating", status: "done" },
      ...
      { name: "Sicherheit", oldUrl: "/sicherheit/", newUrl: "/sicherheit", status: "done" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Cookies", oldUrl: "/cookies/", newUrl: "/cookies", status: "done" },
    ],
  },
  {
    title: "Englisch (/en)",
    items: [
      ...
      { name: "Personal Loan EN", newUrl: "/en/apply-for-credit/personal-loan", status: "done" },
      { name: "SME Loan EN", newUrl: "/en/apply-for-credit/sme-loan", status: "done" },
      { name: "Mortgage EN", newUrl: "/en/apply-for-credit/mortgage", status: "done" },
      { name: "Invest EN", oldUrl: "/en/invest/", newUrl: "/en/invest", status: "done" },
      { name: "Private Investors EN", newUrl: "/en/invest/private-investors", status: "done" },
      { name: "Institutional EN", newUrl: "/en/invest/institutional", status: "done" },
      { name: "About EN", oldUrl: "/en/about/", newUrl: "/en/about", status: "done" },
      { name: "Crowdlending EN", newUrl: "/en/about/crowdlending", status: "done" },
      { name: "Statistics EN", newUrl: "/en/about/statistics", status: "done" },
      { name: "Jobs EN", newUrl: "/en/about/jobs", status: "done" },
      { name: "Partners EN", newUrl: "/en/about/partners", status: "done" },
      { name: "Press EN", newUrl: "/en/about/press", status: "done" },
      { name: "Rating EN", newUrl: "/en/about/rating", status: "done" },
      { name: "Blog EN", newUrl: "/en/about/blog", status: "done" },
      { name: "Terms EN", newUrl: "/en/terms", status: "done" },
      { name: "Privacy EN", newUrl: "/en/privacy", status: "done" },
      { name: "Imprint EN", newUrl: "/en/imprint", status: "done" },
      { name: "Security EN", newUrl: "/en/security", status: "done" },
      { name: "Cookies EN", newUrl: "/en/cookies", status: "done" },
      { name: "Login EN", newUrl: "/en/login", status: "done" },
      { name: "How It Works EN", newUrl: "/en/how-it-works", status: "done" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Crédit privé FR", newUrl: "/fr/demander-un-credit/credit-prive", status: "done" },
      { name: "Crédit PME FR", newUrl: "/fr/demander-un-credit/credit-pme", status: "done" },
      { name: "Hypothèque FR", newUrl: "/fr/demander-un-credit/hypotheque", status: "done" },
      { name: "Investir FR", oldUrl: "/fr/investir/", newUrl: "/fr/investir", status: "done" },
      { name: "Investisseurs privés FR", newUrl: "/fr/investir/investisseurs-prives", status: "done" },
      { name: "Institutionnels FR", newUrl: "/fr/investir/institutionnels", status: "done" },
      { name: "À propos FR", oldUrl: "/fr/a-propos/", newUrl: "/fr/a-propos", status: "done" },
      { name: "Crowdlending FR", newUrl: "/fr/a-propos/crowdlending", status: "done" },
      { name: "Statistiques FR", newUrl: "/fr/a-propos/statistiques", status: "done" },
      { name: "Emplois FR", newUrl: "/fr/a-propos/emplois", status: "done" },
      { name: "Partenaires FR", newUrl: "/fr/a-propos/partenaires", status: "done" },
      { name: "Presse FR", newUrl: "/fr/a-propos/presse", status: "done" },
      { name: "Rating FR", newUrl: "/fr/a-propos/rating", status: "done" },
      { name: "Blog FR", newUrl: "/fr/a-propos/blog", status: "done" },
      { name: "CGV FR", newUrl: "/fr/cgv", status: "done" },
      { name: "Confidentialité FR", newUrl: "/fr/confidentialite", status: "done" },
      { name: "Mentions légales FR", newUrl: "/fr/mentions-legales", status: "done" },
      { name: "Sécurité FR", newUrl: "/fr/securite", status: "done" },
      { name: "Cookies FR", newUrl: "/fr/cookies", status: "done" },
      { name: "Login FR", newUrl: "/fr/login", status: "done" },
      { name: "Comment ça marche FR", newUrl: "/fr/comment-ca-marche", status: "done" },
    ],
  },
  {
    title: "Funktionen & Komponenten",
    items: [
      { name: "Kreditrechner", status: "done", notes: "Island component (Home, Private, SME, Hypothek)" },
      { name: "Newsletter Formular", status: "done", notes: "In Footer integriert" },
      { name: "404 Seite", status: "done", notes: "Mit Animation, Stripe-Style" },
      { name: "Kontaktformular", status: "not-needed", notes: "Extern: support.cashare.ch" },
      { name: "Login Seite", status: "done", newUrl: "/login", notes: "Split-screen Design, 3 Sprachen" },
      { name: "Passwort zurücksetzen", status: "done", newUrl: "/passwort-zuruecksetzen", notes: "3 Sprachen" },
      { name: "Stripe-Style Navigation", status: "done", notes: "Mega-Menu mit Hover-Effekten" },
      { name: "Footer", status: "done", notes: "Trust Badges, Newsletter, Social Links" },
      { name: "Styleguide", status: "done", newUrl: "/styleguide", notes: "Komponenten-Dokumentation" },
    ],
  },
];
